...
export const schedule = [
  {
    ...
    items: [
      { ico: "🎉", time: "10:30 – 11:30 AM", event: "Inauguration", spk: null, inst: "", hl: true },
      { ico: "☕", time: "11:30 – 12:00 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🎙️", time: "12:00 – 1:30 PM", event: "Emerging Control, AI & Cybersecurity", spk: "Dr. Kalyan Chatterjee", inst: "IIT (ISM) Dhanbad", hl: true },
      { ico: "🍽️", time: "1:30 – 2:30 PM", event: "Lunch", spk: null, inst: "", hl: false },
      { ico: "⚡", time: "2:30 – 5:30 PM", event: "Digital Controllers in Power Converters", spk: "Dr. Rajesh Gupta", inst: "NIT Allahabad", hl: true },
    ],
  },
  {
    day: "Day 2", subtitle: "EV Charging & Microgrid", date: "19 May 2026",
    items: [
      { ico: "🔌", time: "9:30 – 10:30 AM", event: "Z-Source Inverter EV Charger", spk: "Dr. Sumant G. Kadwane", inst: "Yeshwantrao Chavan College of Engineering.", hl: true },
      { ico: "🚗", time: "10:30 – 11:30 AM", event: "EV Charging & Grid Interaction", spk: "Dr. Ritesh Kumar Keshri", inst: "VNIT Nagpur", hl: true },
      { ico: "☕", time: "11:30 – 11:45 AM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🏘️", time: "11:45 AM – 1:00 PM", event: "Energy Management for Microgrid", spk: "Dr. Arghya Mitra", inst: "VNIT Nagpur", hl: true },
      { ico: "🍽️", time: "1:00 – 2:30 PM", event: "Lunch", spk: null, inst: "", hl: false },
      { ico: "⚗️", time: "2:30 – 4:00 PM", event: "PEM Fuel Cell Stability (Port-Hamiltonian)", spk: "Dr. Lalitesh Kumar", inst: "SUSTECH, Shenzhen, China", hl: true },
      { ico: "☕", time: "4:00 – 4:15 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🛡️", time: "4:15 – 5:45 PM", event: "Cyber Resiliency of Power Networks", spk: "Dr. Subhojit Ghosh", inst: "NIT Raipur", hl: true },
    ],
  },
  {
    day: "Day 3", subtitle: "Smart Systems & Solar PV", date: "20 May 2026",
    items: [
      { ico: "🌱", time: "9:30 – 10:30 AM", event: "Green Hydrogen Power Supplies", spk: "Shrinivas Bhaskar Karanki", inst: "(TBA)", hl: true },
      { ico: "💻", time: "10:30 – 11:30 AM", event: "Writing Firmware for Energy-Efficient System", spk: "Pratyush Anand", inst: "Microsoft", hl: true },
      { ico: "☕", time: "11:30 – 11:45 AM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🚀", time: "11:45 AM – 1:00 PM", event: "Future of EV Charging Systems", spk: "Dr. Giambattista Gruosso", inst: "Politecnico di Milano, Italy", hl: true },
      { ico: "🍽️", time: "1:00 – 2:30 PM", event: "Lunch", spk: null, inst: "", hl: false },
      { ico: "🔬", time: "2:30 – 4:00 PM", event: "Smart Controllers for PV Inverter", spk: "Dr. Deepak Kumar", inst: "BIT Mesra", hl: true },
      { ico: "☕", time: "4:00 – 4:15 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "☀️", time: "4:15 – 5:30 PM", event: "Solar PV Systems Integrated with Grid", spk: "Dr. T. Ghose", inst: "BIT Mesra", hl: true },
    ],
  },
  {
    day: "Day 4", subtitle: "Smart Grid, Wind & AI", date: "21 May 2026",
    items: [
      { ico: "📡", time: "9:30 – 10:30 AM", event: "PMU Applications in Smart Grid", spk: "Dr. M. Jaya Bharata Reddy", inst: "NIT Tiruchirappalli", hl: true },
      { ico: "🌬️", time: "10:30 – 11:30 AM", event: "Wind Energy Control Systems", spk: "Prof. K.B. Mohanty", inst: "NIT Rourkela", hl: true },
      { ico: "☕", time: "11:30 – 11:45 AM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🧠", time: "11:45 AM – 1:00 PM", event: "Adaptive Control for Microgrids", spk: "Prof. Bidyadhar Subudhi", inst: "IIT Goa", hl: true },
      { ico: "🍽️", time: "1:00 – 2:30 PM", event: "Lunch", spk: null, inst: "", hl: false },
      { ico: "⚙️", time: "2:30 – 3:30 PM", event: "Development & Implementation of Power in SPV", spk: "Dr. Ajay Kumar", inst: "Punjab Engineering College", hl: true },
      { ico: "☕", time: "4:00 – 4:15 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "🤖", time: "4:15 – 5:30 PM", event: "AI in Autonomous Vehicles & Smart Agriculture", spk: "Dr. S.K. Mishra", inst: "BIT Mesra", hl: true },
    ],
  },
  {
    day: "Day 5", subtitle: "HV Systems & Closing", date: "22 May 2026",
    items: [
      { ico: "⚡", time: "10:00 – 11:30 AM", event: "HV Systems & Renewable Integration", spk: "Dr. Soumya Chatterjee", inst: "NIT Durgapur", hl: true },
      { ico: "☕", time: "11:30 – 11:45 AM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "♻️", time: "11:45 AM – 1:30 PM", event: "Control Techniques for RE Applications", spk: "Dr. Aditya R. Gautam", inst: "BITS Pilani", hl: true },
      { ico: "🍽️", time: "1:30 – 2:30 PM", event: "Lunch", spk: null, inst: "", hl: false },
      { ico: "🏆", time: "4:00 PM Onwards", event: "Valedictory", spk: null, inst: "", hl: true },
    ],
  },
];
