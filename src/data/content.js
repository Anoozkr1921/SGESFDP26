...
export const schedule = [
  ...
  },
  {
    ...
    items: [
      ...
      { ico: "⚡", time: "11:45 AM – 01:00 PM", event: "Digital Controllers in Power Converters", spk: "Dr. Rajesh Gupta", inst: "NIT Allahabad", hl: true },
      ...
      { ico: "🛡️", time: "04:15 – 05:45 PM", event: "Cyber Resiliency of Power Networks", spk: "Dr. Subhojit Ghosh", inst: "NIT Raipur", hl: true },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { ico: "🍽️", time: "01:00 – 02:30 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "⚙️", time: "02:30 – 03:30 PM", event: "Development & Implementation of Power in SPV", spk: "Dr. Ajay Kumar", inst: "Punjab Engineering College", hl: true },
      { ico: "☕", time: "04:00 – 04:15 PM", event: "Tea Break", spk: null, inst: "", hl: false },
