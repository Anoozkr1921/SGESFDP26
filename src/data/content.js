...
export const schedule = [
  {
    ...
    items: [
      { ico: "📝", time: "09:30 – 10:30 AM", event: "Registration", spk: null, inst: "", hl: true },
  ...
  },
  {
    ...
    items: [
      { ico: "🔌", time: "09:30 – 10:30 AM", event: "Z-Source Inverter EV Charger", spk: "Dr. Sumant G. Kadwane", inst: "Yeshwantrao Chavan College of Engineering.", hl: true },
      { ico: "🎙️", time: "10:30 – 11:30 AM", event: "Emerging Control, AI & Cybersecurity", spk: "Dr. Kalyan Chatterjee", inst: "IIT (ISM) Dhanbad", hl: true },
      { ico: "☕", time: "11:30 – 11:45 AM", event: "Tea Break", spk: null, inst: "", hl: false },
      { ico: "⚡", time: "11:45 AM – 01:00 PM", event: "Digital Controllers in Power Converters", spk: "Dr. Subhojit Ghosh", inst: "NIT Raipur", hl: true },
      { ico: "🍽️", time: "01:00 – 02:30 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "⚗️", time: "02:30 – 04:00 PM", event: "PEM Fuel Cell Stability (Port-Hamiltonian)", spk: "Dr. Lalitesh Kumar", inst: "SUSTECH, Shenzhen, China", hl: true },
      { ico: "☕", time: "04:00 – 04:15 PM", event: "Tea Break", spk: null, inst: "", hl: false },
      { ico: "🛡️", time: "04:15 – 05:45 PM", event: "Cyber Resiliency of Power Networks", spk: "Dr. Rajesh Gupta", inst: "NIT Allahabad", hl: true },
    ],
  },
  {
    ...
    items: [
      ...
      { ico: "☕", time: "11:00 – 11:15 AM", event: "Tea Break", spk: null, inst: "", hl: false },
      { ico: "🚀", time: "11:15 AM – 12:30 PM", event: "Shaping the Future of EV Charging: Impacts and Integration with Power, Communication and ICT Systems", spk: "Dr. Giambattista Gruosso", inst: "Politecnico di Milano, Italy", hl: true },
      { ico: "🍽️", time: "12:30 – 02:00 PM", event: "Break", spk: null, inst: "", hl: false },
      { ico: "☀️", time: "02:00 – 03:30 PM", event: "Reliability Prediction in Solar Energy Systems", spk: "Dr. Sudhanshu Kumar Mishra", inst: "BIT Mesra, Ranchi", hl: true },
      { ico: "☕", time: "03:30 – 03:45 PM", event: "Tea Break", spk: null, inst: "", hl: false },
      { ico: "☀️", time: "03:45 – 05:00 PM", event: "Solar PV Systems Integrated with Grid", spk: "Dr. T. Ghose", inst: "BIT Mesra", hl: true },
    ],
  },
  {
...
export const speakers = [
...

  {
    ...
    bio: "Dr. Shiva S. Sarode is associated with the Department of Electrical and Electronics Engineering at BIT Mesra and works in sustainable energy and Power Electronics Applications.",
  },
