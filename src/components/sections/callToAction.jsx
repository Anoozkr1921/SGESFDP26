      ...
      <div className="sec" style={{ paddingTop: 0, paddingBottom: 0 }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "3.5rem" }} className="reg-left">
            ...
            <div>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.85rem", marginBottom: "2.5rem" }}>
                <img
                  src={gssirImage}
                ...
                />
                <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.35rem", fontWeight: 900, color: "#022c22", margin: 0 }}>
